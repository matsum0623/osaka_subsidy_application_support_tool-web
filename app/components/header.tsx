  ...
  return (
    <div className="flex">
      <div className="ms-auto p-2 hidden sm:flex sm:gap-4">
        {(!matches[2].pathname.includes('/monthly')) && <div>
          <Link to="/monthly" className="hidden sm:flex text-sm sm:text-xl font-semibold leading-6 text-gray-900 underline sm:py-2">月次報告</Link>
        </div>}
        {(!matches[2].pathname.includes('/admin')) && (!matches[2].pathname.includes('/after_school_settings')) && <div>
          {
