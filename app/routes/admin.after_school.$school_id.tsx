    ...
    <div>
      ...
      <Form method="post">
        <div className="flex my-2">
          <div>
            <p className="text-2xl font-bold">学童{data.create ? "追加" : "情報修正"}</p>
          </div>
        </div>
        <div className="mt-2 px-5">
          ...
          <div className="mt-4">
            ...
            <button type="button" className={"btn btn-primary ml-6" + (data.create ? " hidden" : "")} onClick={() => navigate(`../holidays/${data.school_id}`)}>休日設定</button>
          ...
          <div className="col">
            <div className="flex justify-start">
              <div className="flex">
                ...
                <button type="button" className="btn btn-danger mt-3" onClick={() => navigate('/admin')}>キャンセル</button>
              </div>
